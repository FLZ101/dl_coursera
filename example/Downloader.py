...
from dl_coursera.Downloader import (
    DownloaderAria2,
    DownloaderAria2_input_file,
    DownloaderAria2_rpc,
    DownloaderBuiltin,
    DownloaderCurl,
    DownloaderCurl_input_file,
    DownloaderUget,
)
    ...
    return [
        {
            ...
            'filename': os.path.abspath(
                os.path.join(_outdir, how, 'dum', 'my', '%02d.jpg' % i)
            ),
        }
...
def download_input_file(dl_tasks, how):
    _cls_downloader = {
        'curl': DownloaderCurl_input_file,
        'aria2': DownloaderAria2_input_file,
    }[how]
...
def main():
    ...
    parser.add_argument(
        '--aria2-rpc-secret', help='authorization token of the aria2 XML-RPC interface'
    )
